...
const CaloriesRemaining = ({goal, food, exercise}) => {
  return (
    <View style={styles.counter}>
            <Text style={{fontSize: 16, color: colors.PURE_WHITE, fontWeight: '900', fontFamily: font.DEFAULT_FONT}}>
              Calories Remaining
            </Text>
            <View style={styles.calculator}>
              ...
              <View style={styles.childCalculator}>
                <Ionicons name="remove-outline" size={24} color={colors.PURE_WHITE} />
              </View>
              <View style={styles.childCalculator}>
